...
public class RegistroCSVFile implements RegistroLigacaoStrategy
{
	...
	public void registrar1Modo(Entidade entidadeA, Entidade entidadeB, Portaria portaria)
	{
		try
		{
			...
			String txt = entidadeA.entidade + SEPARATOR + entidadeB.entidade + SEPARATOR + portaria.identificacaoPortaria;

			out.println(txt);
			out.flush();
			out.close();

			out2 = new PrintWriter(new FileOutputStream(PATH + portaria.identificacaoPortaria, true));
			String txt2 = portaria.textoPortaria;
