...
/****** Object:  View [dbo].[VwEntidadeParticao2Nivel]    Script Date: 31/07/2013 17:31:42 ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[VwEntidadeParticao2Nivel] AS
SELECT 
	 N2.No_Orgao as Nome, N2.Co_Orgao as Co_Orgao, N2.Co_Orgao_Pai as Particao
FROM 
...
WHERE 
	...
	AND N2.No_Orgao not in ('Gabinete da Presidência'
,'Coordenação'
...
'Coordenação', 'Presidência','Comitês Técnicos', 'Comissão Técnica', 'Comissão de Ética', 'Secretaria-Geral', 'Assessoria Militar',
