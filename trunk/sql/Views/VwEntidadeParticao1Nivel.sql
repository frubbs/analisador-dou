...
/****** Object:  View [dbo].[VwEntidadeParticao1Nivel]    Script Date: 31/07/2013 17:31:29 ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[VwEntidadeParticao1Nivel] AS
SELECT 
	 N.No_Orgao as Nome, N.Co_Orgao as Co_Orgao, N.Co_Orgao as Particao
FROM 
...
AND N.No_Orgao not in ('Gabinete da Presidência'
,'Coordenação'
